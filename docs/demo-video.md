...
| Time | Say / show |
|------|------------|
| 0:00–0:20 | **Problem:** insights from talks/blogs don’t become agent skills fitted to *your* repo. Marketplaces sell generic skills; fondof forges from source. |
| 0:20–0:35 | **Kiro:** flash `.kiro/specs/fondof/` + steering — Spec → Ship. Hero job: short fitted skill → hand to agent → SkillPool proves use. |
